      ...
      <Container className="flex flex-wrap">
        <div className="flex items-center w-full lg:w-1/2 lg:pr-10">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-text lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-text">
              Art of the Possible  Plastic Surgery Clinic 
            </h1>
            <p className="py-5 text-xl leading-normal text-muted lg:text-xl xl:text-2xl dark:text-muted">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-text bg-primary rounded-md ">
                Κλείσε ραντεβού
              </a>
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center space-x-2 text-muted dark:text-muted px-8">
