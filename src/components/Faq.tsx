      ...
      <div className="space-y-5">
        {faqdata.map((item) => (
          <Disclosure key={item.question}>
            {({ open }) => (
              <>
                <DisclosureButton className="flex w-full items-center justify-between rounded-lg border-2 border-border bg-card/20 px-4 py-4 text-left text-lg font-semibold text-text transition hover:bg-card/40 hover:border-3 focus:outline-none focus-visible:ring focus-visible:ring-primary focus-visible:ring-opacity-75">
